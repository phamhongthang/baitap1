            ...
            <div class="row">
                <div class="col-md-12 food-search">
                    <div class="input-group mb-3 search">
                        <input type="text" class="form-control" placeholder="Search for Foods"
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text food-detail"><small class="text-muted">Chicken Dumpling
                                                    with herbs from
                                                    Moutains.</small></p>
                                            <a href="" class="btn btn-danger">Oder now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text food-detail"><small class="text-muted">Best Firewood Pizza in Town.</small>
                                            </p>
                                            <a href="" class="btn btn-danger">Oder now</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text food-detail"><small class="text-muted">Pizza with
                                                chicken ,Ham,Buff,Mushroom
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text food-detail"><small class="text-muted">Burger with
                                                    Ham,Pineapple and lost of
                                                    Cheese.</small></p>
                                            <a href="" class="btn btn-danger">Oder now</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">$6.00</p>
                                            <p class="card-text food-detail"><small class="text-muted">Best Spicy Momo for Winter.</small></p>
                                            <a href="" class="btn btn-danger">Oder now</a>
                                        </div>
                                    </div>
                                </div>
